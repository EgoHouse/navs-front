...
interface ShishaInfoPageProps {
  onStartQuiz: () => void;
}

const ShishaInfoPage = memo<ShishaInfoPageProps>(({ onStartQuiz }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('${SHISHA_BACKGROUND_IMAGE}')`,
        }}
      >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-light mb-6 text-white tracking-tight font-['Poppins'] [text-shadow:0_4px_12px_rgb(0_0_0/50%)]">
              Algo para fumar
            </h1>

            <p className="text-xl md:text-2xl text-white/90 mx-auto font-light leading-relaxed [text-shadow:0_2px_8px_rgb(0_0_0/50%)]">
